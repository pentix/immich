...
export const LibraryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllLibraries(requestParameters: LibraryApiGetAllLibrariesRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<LibraryResponseDto>> {
            return localVarFp.getAllLibraries(requestParameters.assetId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLibraryCount(options?: AxiosRequestConfig): AxiosPromise<number> {
